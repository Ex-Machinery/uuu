...
> 图1 用例图（占位）：在此处插入 PNG 文件：fig1.png
...
> 图2 订单业务流程图（占位）：在此处插入 PNG 文件：fig2.png
...
> 图3 数据流图 0 层（占位）：在此处插入 PNG 文件：fig3.png

说明（0 层）：
- 展示系统与外部实体（用户、商家、配送员、微信支付）的交互，以及主要的数据存储（数据库）。

> 图4 数据流图 1 层（占位）：在此处插入 PNG 文件：fig4.png
...
（注：图表为占位，文件名分别为 fig1.png、fig2.png、fig3.png、fig4.png。你可用你自己的 PNG 文件替换这些占位图，并在 Word 中直接插入。）
